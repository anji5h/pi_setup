...
if [ -f "sdmon_exporter/sdmon_exporter.sh" ]; then
    ...
    sudo cp sdmon_exporter/sdmon_exporter.sh /usr/local/bin/
...
if [ -f "sdmon_exporter/sdmon_exporter.service" ]; then
    ...
    sudo cp sdmon_exporter/sdmon_exporter.service /etc/systemd/system/
else
...
if [ -f "sdmon_exporter/sdmon_exporter.timer" ]; then
    ...
    sudo cp sdmon_exporter/sdmon_exporter.timer /etc/systemd/system/
else
